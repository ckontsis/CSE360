...
public class mainController implements Initializable {	
    ...
    private String[] List = {"Main", "Appetizers", "...", "Side"};
	...
	public void getValue(ActionEvent event)
	{
		...
		String a = Combo1.getValue();
		Food abc = (Food) menu.get(0);
		Drink cdf;
		//label1.setText(a);
		...
		for(int i = 0; i < menu.size(); i++) { 
			...
			{
				 cdf = (Drink) menu.get(i);
			}
			
			if(a.equalsIgnoreCase(abc.getFoodType()))
			{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		Combo1.getItems().addAll(List);
		Combo1.setOnAction(this::getValue);
